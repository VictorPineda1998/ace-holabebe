            ...
            @if ($pacientes)
                ...
                @foreach ($pacientes as $paciente)
                    ...
                    <li
                        ...
                        <div class="flex w-full lg:w-1/12 mb-2 lg:mb-0">
                            <span class="font-bold lg:hidden">Detalles: </span>
                        ...
                        <div class="flex w-full lg:w-2/12 mb-2 lg:mb-0">
                            ...
                            <span class="ms-1 flex text-sm lg:text-base">
                                @if (!$hayConsulta)
                    ...
                    <div id="myModal{{ $i }}" class="modal">
                        <div class="modal-content w-full md:w-1/2">
                            <div>
                                ...
                                <form class="mt-2" action="{{ route('calendario.store', $paciente->id) }}"
