        ...
        <div style="width: 1135px">
            @if ($pacientes)
                <ul class="flex items-center bg-pink-500 p-3 rounded-t-lg">
                    <span class="w-1/12 text-sm lg:text-base">ID</span>
                ...
                @foreach ($pacientes as $paciente)
                    ...
                    <li class="flex items-center border-b py-2 {{ $loop->odd ? 'bg-pink-300' : 'bg-pink-200' }}"
                        style="padding: 1%">
                        <span class="w-1/12 text-sm lg:text-base">{{ $paciente->id }}</span>
                        ...
                        <span class="w-2/12 text-sm lg:text-base">    
                                             
                                <x-boton-editar class="mostrarFormulario" data-boton="{{ $i }}">
                                    Agregar una consultas
                                </x-boton-editar>
                    ...
                    <div id="myModal{{ $i }}" class="modal">
                        <div class="modal-content w-full md:w-1/2">
                            <div>
                                ...
                                <form
                                    action="{{ route('calendario.store', $paciente->id) }}"
