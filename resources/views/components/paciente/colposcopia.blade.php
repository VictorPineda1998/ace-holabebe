        ...
        <table class="border-collapse table-auto w-full whitespace-no-wrap bg-transparent table-striped relative">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border-indigo-600 border-2 {{-- bg-red-bg-gray-300 --}} px-4 py-2">
                ...
                <tr>
                    <th colspan="4" class="border-indigo-600 bg-gray-300 border-2 px-4 py-2">Antecedentes patologicos personales
                    </th>
                </tr>
                <tr>
                ...
                <tr>
                    <th colspan="4" class="border-indigo-600 bg-gray-300 border-2 px-4 py-2">Antecedentes gineco-obstetricos</th>
                </tr>
                <tr>
